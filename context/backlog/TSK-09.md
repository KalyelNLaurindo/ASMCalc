...
* [x] `src/math.asm` and `src/io.asm` updated with float subroutines.

## 🏁 Definition of Done (DoD) & Acceptance Criteria
* [x] **[Functional]:** Calculator supports operations on decimal numbers (e.g., `5.5 + 4.5 = 10.000000`).
* [x] **[UX/CLI]:** ANS register dynamically formats floats. Non-numeric inputs show clean highlights without crashing.
* [x] **[Resilience]:** Program remains stable under division by zero and invalid decimal structures.
